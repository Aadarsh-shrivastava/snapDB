...
const ExcelSheet = ({ rowData, columnData, datatree, collection_name }) => {
    ...
    return (
        <>
            <button className="btn btn-outline-primary p-1 m-2" onClick={addEntity}>Add Entity</button>
            <button className="btn btn-outline-primary p-1 m-2" onClick={onAddData}>Add Data</button>
                ...
                <div className="header-row">
                    {headings.map((column, colIndex) => (
                        <div className="header-cell-container">
                            ...
                            <button className="delete-button icon icon-tabler icon-tabler-trash" onClick={() => { deleteColumn(column.field) }}>
